  ...
  Future<void> pickAndUploadImages(BuildContext context) async {
    ...
    Future<void> pickAndUploadProfile(BuildContext context) async {
      ...
      if (pickedFilesProfile.length > 1) {
        print("You can select up to 20 images only.");
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("You can select up to 1 image only.")),
        );
        return;
      }
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                SizedBox(height: 20),
                ElevatedButton.icon(
                  //onPressed: isUploadingProfile ? null : () => pickAndUploadProfile(context),
                    onPressed:() => pickAndUploadProfile(context),
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () => pickAndUploadImages(context),
                  icon: Icon(Icons.photo_library),
                ...
                ElevatedButton(
                    onPressed: () async {
                     ...
                     if (_formKey.currentState!.validate()) {
                        ...
                        if (success) {
                          print("Restaurant: $name, $address, $city, $postcode");
